...
def rumor_user_prompt(item: NewsItem) -> str:
    ...
    lines = [
        ...
        "- ③ 내용 요약+코멘트 작성 방식 (중요):",
        "  · 먼저 핵심 내용을 2~3줄로 요약 (영어면 번역해서, 원문 그대로 복사 금지)",
        "  · 그 다음 진천우 시각에서 '이게 왜 흥미로운지' 또는 '어떤 사람한테 도움될지' 1~2줄 코멘트 추가",
        "  · 요약이 빈약하거나 제목/링크만 있어도 제목에서 유추해서 코멘트 써줘",
        "  · 단순 정보 나열 금지 — 진천우답게 반응하듯 써야 함",
